...
//     try {
//       await axios.patch(`http://localhost:5004/users/${userId}`, { password: newPassword });
//       toast.success("Password reset successful!");
//       handleCancel();
//     } catch (error) {
//       console.error(error);
...
//             Welcome Back
//           </h1>
//           <p className="text-gray-600 mt-2">{showForgotPassword ? "Reset your password" : "Sign in to continue"}</p>
//         </div>
...
//                     onChange={handleChange}
//                     required
//                     className="w-full pl-3 pr-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-200"
//                     placeholder="your.email@example.com"
//                   />
//                 </div>
...
//                       onChange={handleChange}
//                       required
//                       className="w-full pl-3 pr-12 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-200"
//                       placeholder="Enter your password"
//                     />
//                     <button
//                       type="button"
...
//                   </label>
//                   <button type="button" onClick={() => setShowForgotPassword(true)} className="text-sm font-semibold text-blue-600 hover:text-blue-700">
//                     Forgot Password?
//                   </button>
//                 </div>
...
//                 <button
//                   type="submit"
//                   className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-3 rounded-xl font-semibold hover:from-blue-700 hover:to-indigo-700 transition duration-200 shadow-lg"
//                 >
//                   Sign In
//                 </button>
//               </form>
...
//                     />
//                   </div>
//                   <button type="submit" className="w-full bg-blue-600 text-white py-3 rounded-xl">Verify Email</button>
//                   <button type="button" onClick={handleCancel} className="w-full bg-gray-100 py-3 rounded-xl">Back to Login</button>
//                 </form>
//               ) : (
//                 <form onSubmit={handlePasswordReset} className="space-y-6">
//                   <div>
...
//                     />
//                   </div>
//                   <button type="submit" className="w-full bg-blue-600 text-white py-3 rounded-xl">Reset Password</button>
//                   <button type="button" onClick={handleCancel} className="w-full bg-gray-100 py-3 rounded-xl">Cancel</button>
//                 </form>
//               )}
//             </>
//           )}
