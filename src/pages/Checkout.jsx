...
//                     <label htmlFor="cod" className="font-semibold text-gray-900">Cash on Delivery (COD)</label>
//                   </div>
...
//                       <p className="text-sm font-bold text-gray-900 mt-1">₹{(item.price * (item.quantity || 1)).toFixed(2)}</p>
//                     </div>
//                   </div>
//                 ))}
//               </div>
...
//                 className="w-full py-4 bg-green-600 text-white font-bold rounded-lg hover:bg-green-700 transition-colors duration-200 shadow-lg hover:shadow-xl"
//               >
//                 Place Order
//               </button>
...
//                 className="w-full py-3 mt-3 border-2 border-gray-300 text-gray-700 font-semibold rounded-lg hover:bg-gray-50 transition-colors duration-200"
//               >
//                 Back to Cart
//               </button>

//               <div className="mt-6 text-center">
//                 <p className="text-xs text-gray-500">🔒 Secure checkout - Your information is safe</p>
//               </div>
//             </div>
//           </div>
//         </div>
